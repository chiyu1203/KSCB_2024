##pong game comes from https://www.geeksforgeeks.org/create-a-pong-game-in-python-pygame/
...
def main():
    ...
    while running:
        ...
        geek1.displayScore("Konstanz Computer : ", geek1Score, 100, 20, WHITE)
